...
(function() {
  $(function() {
    ...
    greenBG = function() {
      return background.attr('opacity', 0.2);
    };
    grid_lines = [];
    grid_size = 540;
    number_text = {};
    ...
    blacken_square = function(i, j) {
      ...
      return black_squares[i][j] = paper.rect(j * square_size + 0.5, i * square_size + 0.5, square_size, square_size).attr({
        fill: '#333'
      });
    };
    ...
    rehighlight = function() {
      ...
      across_highlight.attr({
        ...
        stroke: dir === 'A' ? HIGHLIGHT_PARALLEL : HIGHLIGHT_PERPENDICULAR
      });
      down_si = ci;
      down_ei = ci;
      ...
      down_highlight.attr({
        ...
        stroke: dir === 'D' ? HIGHLIGHT_PARALLEL : HIGHLIGHT_PERPENDICULAR
      });
    ...
    make_puzzle = function(contents) {
      ...
      background = paper.rect(0, 0, grid_size, grid_size).attr({
        stroke: 'none',
        fill: '#62cb62',
        opacity: 0.0
      });
